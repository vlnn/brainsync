...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Україна", "ukraina"),
        ("Київ", "kyiv"),
        ("Юрій Єрмак", "yurii-yermak"),
        ("Згорани", "zghorany"),
        ("Щука й ґанок", "shchuka-y-ganok"),
        ("м’ята та п'ять", "miata-ta-piat"),
        ("Rock'n'roll", "rock-n-roll"),
        ("TDD і Теплиця", "tdd-i-teplytsia"),
        ('Київ Юрій', "kyiv-yurii"),
    ],
    ids=[
        "plain words",
        "punctuation collapses",
        "latin accents fold",
        "nothing left falls back",
        "long names cut at a word boundary",
        "cyrillic transliterates",
        "yi inside a word becomes i",
        "yi at word start",
        "word-initial ye and yu",
        "zg becomes zgh",
        "shch, standalone y and g",
        "apostrophes inside ukrainian words vanish",
        "latin apostrophes still split",
        "mixed scripts",
        "decomposed unicode behaves like composed",
    ],
)
